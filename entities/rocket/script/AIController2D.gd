...
func get_obs() -> Dictionary:
	var result: Array = [rocket.position.x-rocket.goal_pos.x, rocket.position.y-rocket.goal_pos.y, rocket.velocity.x, rocket.velocity.y, rocket.rotation]
